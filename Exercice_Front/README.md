...
## Contexte
La chef de projet a un ticket pour vous. Il s'agit de réaliser une petite application qui crée la / les vues pour les routes précédemment créées dans l'API.
